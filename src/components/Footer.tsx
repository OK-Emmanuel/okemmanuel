        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-4 text-sm text-muted">
              Technology &amp; Product Strategist · Scaling Digital Systems
            </p>
            ...
            <div className="flex items-center gap-5 mt-6">
              ...
              <Link href="https://github.com/okemmanuel" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-muted hover:text-gold transition-colors">
